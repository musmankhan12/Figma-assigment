      ...
      <div className="max-w-[1200px] mx-auto px-4 py-12 flex flex-wrap gap-12">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 mb-6">
            Step into a world of Sophistication and comfort with our exquisite range of Furniture. Each Piece is 
            Metaculously crafted to add a such of elegance to your home. Wheather you are Looking for a Chic Sofa, , 
            a stylish Dinning Table or a cozzy Bed, Our collection promises to elevate your living space with
            timeless designs that blend seamleslywith any decor.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            We Would Love to Hear from you guys wheather it's a Complain, Suggestion or anything
            we can improve. We are here for you at anytime.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div className="text-gray-600">
                <p>Tel: 889-667-77-99</p>
                <p>E-Mail: comfypanda@store.com</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
