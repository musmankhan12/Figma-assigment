...
const LatestBlog: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="mb-8">
        <img
          src="/latest b Top.png" // Replace with your image path
          alt="Top Image"
          className="w-[906px] h-[93px] object-cover mx-auto"
        />
      </div>
        ...
        {blogPosts.map((post) => (
          ...
          >
            ...
            <div className="mt-4">
              ...
              <button className="text-blue-500 hover:text-pink-400 underline mt-4">Read More</button>
            </div>
          </div>
        ))}
      </div>
